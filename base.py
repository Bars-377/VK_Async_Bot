        ...
        try:
            ...
            def get_status_text(state_1, state_2):
                status_map = {
                    ...
                    ("Отправлено курьером", "Ещё не получен"): "Документы в обработке в ведомств",
                    ("Отправлено ЭВ", "Ещё не получен"): "Документы в обработке в ведомств",
                    ("Отправлено курьером и ЭВ", "Исполнено"): "Документы в обработке в ведомств",
                    ("Отправлено курьером и ЭВ", "Промежуточные результаты от ведомства"): "Документы в обработке в ведомств",
                }
