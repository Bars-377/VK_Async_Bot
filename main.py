    ...
    async def filials(message: Message):
        ...
        try:
            ...
            if payload_data == 'filials' or payload_data == 'back_1' or payload_data == 'back':
                ...
                # await message.answer('Уважаемые заявители!\n\n📆 В связи с празднованием Дня народного единства\n«Томский областной многофункциональный центр по предоставлению государственных и муниципальных услуг»\nизменит режим работы:\n1 ноября – рабочий день по режиму понедельника\n3 ноября – рабочий день по режиму субботы\n4 ноября – выходной день\n\nС 5 ноября МФЦ продолжит работу по обычному графику.')
